...
void Pipeline::createGraphicsPipeline() {
  ...
  viewport.x = 0.0f;
  viewport.y = 0.0f;
  viewport.width = static_cast<float>(pipeline_config_.viewportExtent.width);
  viewport.height = static_cast<float>(pipeline_config_.viewportExtent.height);
  viewport.minDepth = 0.0f;
  viewport.maxDepth = 1.0f;

  VkRect2D scissor{};
  scissor.offset = {0, 0};
  scissor.extent = pipeline_config_.viewportExtent;
  ...
  pipelineInfo.renderPass = pipeline_config_.renderPass;
