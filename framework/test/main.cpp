...
/**
 * @return whether to abort validation layer
 *  @retval true: it's normally only used to test the validation layers themselves
 *  @retval false: always use
 */
...
class HelloTriangleApplication {
 ...
 private:
  ...
  void createInstance() {
    ...
    // challenge: check if extensions are all supported
